...
startButton.addEventListener("click", () => {
    ...
    if (input== ""){
        ...
        document.body.innerHTML = "<div class='wrapper'><h2 class='question'> bolroo nadd hairtai yu?</h2>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay! Thank you for loving me Bolroo❤️!</h2>"+
